// ======================================================================
// afstandssensor.v generated from TopDesign.cysch
// 12/17/2020 at 15:05
...
module top ;
    ...
    UART_v2_50_0 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_230),
        .tx_interrupt(Net_231),
        .rx_interrupt(Net_232),
        .tx_data(Net_233),
        .tx_clk(Net_234),
        .rx_data(Net_235),
        .rx_clk(Net_236));
	...
	cy_psoc3_pins_v1_10
		#(.id("d79801f7-745a-460c-8ae3-4d49119e2129"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),

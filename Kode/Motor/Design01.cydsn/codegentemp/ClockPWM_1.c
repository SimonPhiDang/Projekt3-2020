...
/*******************************************************************************
* Function Name: ClockPWM_1_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_Start(void) 
{
    /* Set the bit to enable the clock. */
    ClockPWM_1_CLKEN |= ClockPWM_1_CLKEN_MASK;
	ClockPWM_1_CLKSTBY |= ClockPWM_1_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: ClockPWM_1_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    ClockPWM_1_CLKEN &= (uint8)(~ClockPWM_1_CLKEN_MASK);
	ClockPWM_1_CLKSTBY &= (uint8)(~ClockPWM_1_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: ClockPWM_1_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_StopBlock(void) 
{
    if ((ClockPWM_1_CLKEN & ClockPWM_1_CLKEN_MASK) != 0u)
    {
...
#if defined(ClockPWM_1__CFG3)
        CLK_DIST_AMASK = ClockPWM_1_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ClockPWM_1_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* ClockPWM_1__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(ClockPWM_1_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(ClockPWM_1_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: ClockPWM_1_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        ClockPWM_1_CLKSTBY &= (uint8)(~ClockPWM_1_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: ClockPWM_1_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = ClockPWM_1_GetSourceRegister();
    uint16 oldDivider = ClockPWM_1_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ClockPWM_1_CLKEN & ClockPWM_1_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((ClockPWM_1_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: ClockPWM_1_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 ClockPWM_1_GetDividerRegister(void) 
{
    return CY_GET_REG16(ClockPWM_1_DIV_PTR);
}


/*******************************************************************************
* Function Name: ClockPWM_1_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_SetModeRegister(uint8 modeBitMask) 
{
    ClockPWM_1_MOD_SRC |= modeBitMask & (uint8)ClockPWM_1_MODE_MASK;
}


/*******************************************************************************
* Function Name: ClockPWM_1_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_ClearModeRegister(uint8 modeBitMask) 
{
    ClockPWM_1_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(ClockPWM_1_MODE_MASK));
}


/*******************************************************************************
* Function Name: ClockPWM_1_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ClockPWM_1_GetModeRegister(void) 
{
    return ClockPWM_1_MOD_SRC & (uint8)(ClockPWM_1_MODE_MASK);
}


/*******************************************************************************
* Function Name: ClockPWM_1_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = ClockPWM_1_GetDividerRegister();
    uint8 oldSrc = ClockPWM_1_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        ClockPWM_1_MOD_SRC |= CYCLK_SSS;
        ClockPWM_1_MOD_SRC =
            (ClockPWM_1_MOD_SRC & (uint8)(~ClockPWM_1_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ClockPWM_1_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ClockPWM_1_GetSourceRegister(void) 
{
    return ClockPWM_1_MOD_SRC & ClockPWM_1_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ClockPWM_1_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void ClockPWM_1_SetPhaseRegister(uint8 clkPhase) 
{
    ClockPWM_1_PHASE = clkPhase & ClockPWM_1_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ClockPWM_1_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 ClockPWM_1_GetPhaseRegister(void) 
{
    return ClockPWM_1_PHASE & ClockPWM_1_PHASE_MASK;
}

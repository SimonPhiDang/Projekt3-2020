...
/* Done */
#define Done__0__INTTYPE CYREG_PICU1_INTTYPE6
#define Done__0__MASK 0x40u
#define Done__0__PC CYREG_PRT1_PC6
#define Done__0__PORT 1u
#define Done__0__SHIFT 6u
#define Done__AG CYREG_PRT1_AG
#define Done__AMUX CYREG_PRT1_AMUX
#define Done__BIE CYREG_PRT1_BIE
#define Done__BIT_MASK CYREG_PRT1_BIT_MASK
#define Done__BYP CYREG_PRT1_BYP
#define Done__CTL CYREG_PRT1_CTL
#define Done__DM0 CYREG_PRT1_DM0
#define Done__DM1 CYREG_PRT1_DM1
#define Done__DM2 CYREG_PRT1_DM2
#define Done__DR CYREG_PRT1_DR
#define Done__INP_DIS CYREG_PRT1_INP_DIS
#define Done__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Done__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Done__LCD_EN CYREG_PRT1_LCD_EN
#define Done__MASK 0x40u
#define Done__PORT 1u
#define Done__PRT CYREG_PRT1_PRT
#define Done__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Done__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Done__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Done__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Done__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Done__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Done__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Done__PS CYREG_PRT1_PS
#define Done__SHIFT 6u
#define Done__SLW CYREG_PRT1_SLW

/* Echo */
#define Echo__0__INTTYPE CYREG_PICU3_INTTYPE6
#define Echo__0__MASK 0x40u
#define Echo__0__PC CYREG_PRT3_PC6
#define Echo__0__PORT 3u
#define Echo__0__SHIFT 6u
#define Echo__AG CYREG_PRT3_AG
#define Echo__AMUX CYREG_PRT3_AMUX
#define Echo__BIE CYREG_PRT3_BIE
#define Echo__BIT_MASK CYREG_PRT3_BIT_MASK
#define Echo__BYP CYREG_PRT3_BYP
#define Echo__CTL CYREG_PRT3_CTL
#define Echo__DM0 CYREG_PRT3_DM0
#define Echo__DM1 CYREG_PRT3_DM1
#define Echo__DM2 CYREG_PRT3_DM2
#define Echo__DR CYREG_PRT3_DR
#define Echo__INP_DIS CYREG_PRT3_INP_DIS
#define Echo__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define Echo__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define Echo__LCD_EN CYREG_PRT3_LCD_EN
#define Echo__MASK 0x40u
#define Echo__PORT 3u
#define Echo__PRT CYREG_PRT3_PRT
#define Echo__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define Echo__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define Echo__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define Echo__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define Echo__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define Echo__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define Echo__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define Echo__PS CYREG_PRT3_PS
#define Echo__SHIFT 6u
#define Echo__SLW CYREG_PRT3_SLW

/* PWM1 */
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB00_01_ACTL
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB00_01_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB00_01_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB00_01_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB00_01_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_MASK_MASK_REG CYREG_B0_UDB00_01_MSK
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB00_01_MSK
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB00_01_MSK
#define PWM1_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB00_01_MSK
#define PWM1_PWMUDB_genblk1_ctrlreg__7__MASK 0x80u
#define PWM1_PWMUDB_genblk1_ctrlreg__7__POS 7
#define PWM1_PWMUDB_genblk1_ctrlreg__CONTROL_AUX_CTL_REG CYREG_B0_UDB00_ACTL
#define PWM1_PWMUDB_genblk1_ctrlreg__CONTROL_REG CYREG_B0_UDB00_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__CONTROL_ST_REG CYREG_B0_UDB00_ST_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__COUNT_REG CYREG_B0_UDB00_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__COUNT_ST_REG CYREG_B0_UDB00_ST_CTL
#define PWM1_PWMUDB_genblk1_ctrlreg__MASK 0x80u
#define PWM1_PWMUDB_genblk1_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define PWM1_PWMUDB_genblk1_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define PWM1_PWMUDB_genblk1_ctrlreg__PERIOD_REG CYREG_B0_UDB00_MSK
#define PWM1_PWMUDB_genblk8_stsreg__0__MASK 0x01u
#define PWM1_PWMUDB_genblk8_stsreg__0__POS 0
#define PWM1_PWMUDB_genblk8_stsreg__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB00_01_ACTL
#define PWM1_PWMUDB_genblk8_stsreg__16BIT_STATUS_REG CYREG_B0_UDB00_01_ST
...
#define PWM1_PWMUDB_genblk8_stsreg__MASK_REG CYREG_B0_UDB00_MSK
#define PWM1_PWMUDB_genblk8_stsreg__MASK_ST_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define PWM1_PWMUDB_genblk8_stsreg__PER_ST_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define PWM1_PWMUDB_genblk8_stsreg__STATUS_AUX_CTL_REG CYREG_B0_UDB00_ACTL
#define PWM1_PWMUDB_genblk8_stsreg__STATUS_CNT_REG CYREG_B0_UDB00_ST_CTL
#define PWM1_PWMUDB_genblk8_stsreg__STATUS_CONTROL_REG CYREG_B0_UDB00_ST_CTL
#define PWM1_PWMUDB_genblk8_stsreg__STATUS_REG CYREG_B0_UDB00_ST
#define PWM1_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG CYREG_B0_UDB00_01_A0
#define PWM1_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG CYREG_B0_UDB00_01_A1
#define PWM1_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG CYREG_B0_UDB00_01_D0
#define PWM1_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG CYREG_B0_UDB00_01_D1
#define PWM1_PWMUDB_sP8_pwmdp_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB00_01_ACTL
#define PWM1_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG CYREG_B0_UDB00_01_F0
#define PWM1_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG CYREG_B0_UDB00_01_F1
#define PWM1_PWMUDB_sP8_pwmdp_u0__A0_A1_REG CYREG_B0_UDB00_A0_A1
#define PWM1_PWMUDB_sP8_pwmdp_u0__A0_REG CYREG_B0_UDB00_A0
#define PWM1_PWMUDB_sP8_pwmdp_u0__A1_REG CYREG_B0_UDB00_A1
#define PWM1_PWMUDB_sP8_pwmdp_u0__D0_D1_REG CYREG_B0_UDB00_D0_D1
#define PWM1_PWMUDB_sP8_pwmdp_u0__D0_REG CYREG_B0_UDB00_D0
#define PWM1_PWMUDB_sP8_pwmdp_u0__D1_REG CYREG_B0_UDB00_D1
#define PWM1_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG CYREG_B0_UDB00_ACTL
#define PWM1_PWMUDB_sP8_pwmdp_u0__F0_F1_REG CYREG_B0_UDB00_F0_F1
#define PWM1_PWMUDB_sP8_pwmdp_u0__F0_REG CYREG_B0_UDB00_F0
#define PWM1_PWMUDB_sP8_pwmdp_u0__F1_REG CYREG_B0_UDB00_F1
#define PWM1_PWMUDB_sP8_pwmdp_u0__MSK_DP_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL
#define PWM1_PWMUDB_sP8_pwmdp_u0__PER_DP_AUX_CTL_REG CYREG_B0_UDB00_MSK_ACTL

/* PWM2 */
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB01_02_ACTL
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB01_02_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB01_02_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB01_02_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB01_02_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_MASK_MASK_REG CYREG_B0_UDB01_02_MSK
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB01_02_MSK
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB01_02_MSK
#define PWM2_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB01_02_MSK
#define PWM2_PWMUDB_genblk1_ctrlreg__7__MASK 0x80u
#define PWM2_PWMUDB_genblk1_ctrlreg__7__POS 7
#define PWM2_PWMUDB_genblk1_ctrlreg__CONTROL_AUX_CTL_REG CYREG_B0_UDB01_ACTL
#define PWM2_PWMUDB_genblk1_ctrlreg__CONTROL_REG CYREG_B0_UDB01_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__CONTROL_ST_REG CYREG_B0_UDB01_ST_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__COUNT_REG CYREG_B0_UDB01_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__COUNT_ST_REG CYREG_B0_UDB01_ST_CTL
#define PWM2_PWMUDB_genblk1_ctrlreg__MASK 0x80u
#define PWM2_PWMUDB_genblk1_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB01_MSK_ACTL
#define PWM2_PWMUDB_genblk1_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB01_MSK_ACTL
#define PWM2_PWMUDB_genblk1_ctrlreg__PERIOD_REG CYREG_B0_UDB01_MSK
...
#define PWM2_PWMUDB_genblk8_stsreg__MASK_ST_AUX_CTL_REG CYREG_B0_UDB01_MSK_ACTL
#define PWM2_PWMUDB_genblk8_stsreg__PER_ST_AUX_CTL_REG CYREG_B0_UDB01_MSK_ACTL
#define PWM2_PWMUDB_genblk8_stsreg__STATUS_AUX_CTL_REG CYREG_B0_UDB01_ACTL
#define PWM2_PWMUDB_genblk8_stsreg__STATUS_CNT_REG CYREG_B0_UDB01_ST_CTL
#define PWM2_PWMUDB_genblk8_stsreg__STATUS_CONTROL_REG CYREG_B0_UDB01_ST_CTL
#define PWM2_PWMUDB_genblk8_stsreg__STATUS_REG CYREG_B0_UDB01_ST
#define PWM2_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG CYREG_B0_UDB01_02_A0
#define PWM2_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG CYREG_B0_UDB01_02_A1
#define PWM2_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG CYREG_B0_UDB01_02_D0
#define PWM2_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG CYREG_B0_UDB01_02_D1
#define PWM2_PWMUDB_sP8_pwmdp_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB01_02_ACTL
#define PWM2_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG CYREG_B0_UDB01_02_F0
#define PWM2_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG CYREG_B0_UDB01_02_F1
#define PWM2_PWMUDB_sP8_pwmdp_u0__A0_A1_REG CYREG_B0_UDB01_A0_A1
#define PWM2_PWMUDB_sP8_pwmdp_u0__A0_REG CYREG_B0_UDB01_A0
#define PWM2_PWMUDB_sP8_pwmdp_u0__A1_REG CYREG_B0_UDB01_A1
#define PWM2_PWMUDB_sP8_pwmdp_u0__D0_D1_REG CYREG_B0_UDB01_D0_D1
#define PWM2_PWMUDB_sP8_pwmdp_u0__D0_REG CYREG_B0_UDB01_D0
#define PWM2_PWMUDB_sP8_pwmdp_u0__D1_REG CYREG_B0_UDB01_D1
#define PWM2_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG CYREG_B0_UDB01_ACTL
#define PWM2_PWMUDB_sP8_pwmdp_u0__F0_F1_REG CYREG_B0_UDB01_F0_F1
#define PWM2_PWMUDB_sP8_pwmdp_u0__F0_REG CYREG_B0_UDB01_F0
#define PWM2_PWMUDB_sP8_pwmdp_u0__F1_REG CYREG_B0_UDB01_F1
#define PWM2_PWMUDB_sP8_pwmdp_u0__MSK_DP_AUX_CTL_REG CYREG_B0_UDB01_MSK_ACTL
#define PWM2_PWMUDB_sP8_pwmdp_u0__PER_DP_AUX_CTL_REG CYREG_B0_UDB01_MSK_ACTL
...
#define Timer_1_TimerUDB_sT16_timerdp_u0__MSK_DP_AUX_CTL_REG CYREG_B0_UDB04_MSK_ACTL
#define Timer_1_TimerUDB_sT16_timerdp_u0__PER_DP_AUX_CTL_REG CYREG_B0_UDB04_MSK_ACTL
...
#define Timer_int_1__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define Timer_int_1__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define Timer_int_1__INTC_MASK 0x04u
#define Timer_int_1__INTC_NUMBER 2u
#define Timer_int_1__INTC_PRIOR_NUM 7u
#define Timer_int_1__INTC_PRIOR_REG CYREG_NVIC_PRI_2
#define Timer_int_1__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define Timer_int_1__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
/* Trigger */
#define Trigger__0__INTTYPE CYREG_PICU3_INTTYPE7
#define Trigger__0__MASK 0x80u
#define Trigger__0__PC CYREG_PRT3_PC7
#define Trigger__0__PORT 3u
...
/* ClockPWM */
#define ClockPWM__CFG0 CYREG_CLKDIST_DCFG4_CFG0
#define ClockPWM__CFG1 CYREG_CLKDIST_DCFG4_CFG1
#define ClockPWM__CFG2 CYREG_CLKDIST_DCFG4_CFG2
#define ClockPWM__CFG2_SRC_SEL_MASK 0x07u
#define ClockPWM__INDEX 0x04u
#define ClockPWM__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define ClockPWM__PM_ACT_MSK 0x10u
#define ClockPWM__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define ClockPWM__PM_STBY_MSK 0x10u
#define ClockPWM_1__CFG0 CYREG_CLKDIST_DCFG5_CFG0
#define ClockPWM_1__CFG1 CYREG_CLKDIST_DCFG5_CFG1
#define ClockPWM_1__CFG2 CYREG_CLKDIST_DCFG5_CFG2
#define ClockPWM_1__CFG2_SRC_SEL_MASK 0x07u
#define ClockPWM_1__INDEX 0x05u
#define ClockPWM_1__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define ClockPWM_1__PM_ACT_MSK 0x20u
#define ClockPWM_1__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define ClockPWM_1__PM_STBY_MSK 0x20u
...
#define ADC_SAR_1_IRQ__INTC_MASK 0x08u
#define ADC_SAR_1_IRQ__INTC_NUMBER 3u
#define ADC_SAR_1_IRQ__INTC_PRIOR_NUM 7u
#define ADC_SAR_1_IRQ__INTC_PRIOR_REG CYREG_NVIC_PRI_3
...
/* Clock_10kHz */
#define Clock_10kHz__CFG0 CYREG_CLKDIST_DCFG3_CFG0
#define Clock_10kHz__CFG1 CYREG_CLKDIST_DCFG3_CFG1
#define Clock_10kHz__CFG2 CYREG_CLKDIST_DCFG3_CFG2
#define Clock_10kHz__CFG2_SRC_SEL_MASK 0x07u
#define Clock_10kHz__INDEX 0x03u
#define Clock_10kHz__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clock_10kHz__PM_ACT_MSK 0x08u
#define Clock_10kHz__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clock_10kHz__PM_STBY_MSK 0x08u

/* Control_Reg */
#define Control_Reg_Sync_ctrl_reg__0__MASK 0x01u
#define Control_Reg_Sync_ctrl_reg__0__POS 0
#define Control_Reg_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB07_08_ACTL
#define Control_Reg_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB07_08_CTL
#define Control_Reg_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB07_08_CTL
#define Control_Reg_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB07_08_CTL
#define Control_Reg_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB07_08_CTL
#define Control_Reg_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B0_UDB07_08_MSK
#define Control_Reg_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB07_08_MSK
#define Control_Reg_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB07_08_MSK
#define Control_Reg_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB07_08_MSK
#define Control_Reg_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B0_UDB07_ACTL
#define Control_Reg_Sync_ctrl_reg__CONTROL_REG CYREG_B0_UDB07_CTL
#define Control_Reg_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B0_UDB07_ST_CTL
#define Control_Reg_Sync_ctrl_reg__COUNT_REG CYREG_B0_UDB07_CTL
#define Control_Reg_Sync_ctrl_reg__COUNT_ST_REG CYREG_B0_UDB07_ST_CTL
#define Control_Reg_Sync_ctrl_reg__MASK 0x01u
#define Control_Reg_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB07_MSK_ACTL
#define Control_Reg_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB07_MSK_ACTL
#define Control_Reg_Sync_ctrl_reg__PERIOD_REG CYREG_B0_UDB07_MSK

/* PWM_Trigger */
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB06_07_ACTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB06_07_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB06_07_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB06_07_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB06_07_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_MASK_MASK_REG CYREG_B1_UDB06_07_MSK
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB06_07_MSK
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB06_07_MSK
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB06_07_MSK
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__7__MASK 0x80u
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__7__POS 7
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__CONTROL_AUX_CTL_REG CYREG_B1_UDB06_ACTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__CONTROL_REG CYREG_B1_UDB06_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__CONTROL_ST_REG CYREG_B1_UDB06_ST_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__COUNT_REG CYREG_B1_UDB06_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__COUNT_ST_REG CYREG_B1_UDB06_ST_CTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__MASK 0x80u
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB06_MSK_ACTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB06_MSK_ACTL
#define PWM_Trigger_PWMUDB_genblk1_ctrlreg__PERIOD_REG CYREG_B1_UDB06_MSK
#define PWM_Trigger_PWMUDB_genblk8_stsreg__0__MASK 0x01u
#define PWM_Trigger_PWMUDB_genblk8_stsreg__0__POS 0
#define PWM_Trigger_PWMUDB_genblk8_stsreg__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB07_08_ACTL
#define PWM_Trigger_PWMUDB_genblk8_stsreg__16BIT_STATUS_REG CYREG_B0_UDB07_08_ST
#define PWM_Trigger_PWMUDB_genblk8_stsreg__2__MASK 0x04u
#define PWM_Trigger_PWMUDB_genblk8_stsreg__2__POS 2
#define PWM_Trigger_PWMUDB_genblk8_stsreg__3__MASK 0x08u
#define PWM_Trigger_PWMUDB_genblk8_stsreg__3__POS 3
#define PWM_Trigger_PWMUDB_genblk8_stsreg__MASK 0x0Du
#define PWM_Trigger_PWMUDB_genblk8_stsreg__MASK_REG CYREG_B0_UDB07_MSK
#define PWM_Trigger_PWMUDB_genblk8_stsreg__MASK_ST_AUX_CTL_REG CYREG_B0_UDB07_MSK_ACTL
#define PWM_Trigger_PWMUDB_genblk8_stsreg__PER_ST_AUX_CTL_REG CYREG_B0_UDB07_MSK_ACTL
#define PWM_Trigger_PWMUDB_genblk8_stsreg__STATUS_AUX_CTL_REG CYREG_B0_UDB07_ACTL
#define PWM_Trigger_PWMUDB_genblk8_stsreg__STATUS_CNT_REG CYREG_B0_UDB07_ST_CTL
#define PWM_Trigger_PWMUDB_genblk8_stsreg__STATUS_CONTROL_REG CYREG_B0_UDB07_ST_CTL
#define PWM_Trigger_PWMUDB_genblk8_stsreg__STATUS_REG CYREG_B0_UDB07_ST
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG CYREG_B0_UDB06_07_A0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG CYREG_B0_UDB06_07_A1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG CYREG_B0_UDB06_07_D0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG CYREG_B0_UDB06_07_D1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB06_07_ACTL
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG CYREG_B0_UDB06_07_F0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG CYREG_B0_UDB06_07_F1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__A0_A1_REG CYREG_B0_UDB06_A0_A1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__A0_REG CYREG_B0_UDB06_A0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__A1_REG CYREG_B0_UDB06_A1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__D0_D1_REG CYREG_B0_UDB06_D0_D1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__D0_REG CYREG_B0_UDB06_D0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__D1_REG CYREG_B0_UDB06_D1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__DP_AUX_CTL_REG CYREG_B0_UDB06_ACTL
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__F0_F1_REG CYREG_B0_UDB06_F0_F1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__F0_REG CYREG_B0_UDB06_F0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u0__F1_REG CYREG_B0_UDB06_F1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__16BIT_A0_REG CYREG_B0_UDB07_08_A0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__16BIT_A1_REG CYREG_B0_UDB07_08_A1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__16BIT_D0_REG CYREG_B0_UDB07_08_D0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__16BIT_D1_REG CYREG_B0_UDB07_08_D1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB07_08_ACTL
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__16BIT_F0_REG CYREG_B0_UDB07_08_F0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__16BIT_F1_REG CYREG_B0_UDB07_08_F1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__A0_A1_REG CYREG_B0_UDB07_A0_A1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__A0_REG CYREG_B0_UDB07_A0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__A1_REG CYREG_B0_UDB07_A1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__D0_D1_REG CYREG_B0_UDB07_D0_D1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__D0_REG CYREG_B0_UDB07_D0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__D1_REG CYREG_B0_UDB07_D1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__DP_AUX_CTL_REG CYREG_B0_UDB07_ACTL
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__F0_F1_REG CYREG_B0_UDB07_F0_F1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__F0_REG CYREG_B0_UDB07_F0
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__F1_REG CYREG_B0_UDB07_F1
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__MSK_DP_AUX_CTL_REG CYREG_B0_UDB07_MSK_ACTL
#define PWM_Trigger_PWMUDB_sP16_pwmdp_u1__PER_DP_AUX_CTL_REG CYREG_B0_UDB07_MSK_ACTL

/* Clock_100kHz */
#define Clock_100kHz__CFG0 CYREG_CLKDIST_DCFG1_CFG0
#define Clock_100kHz__CFG1 CYREG_CLKDIST_DCFG1_CFG1
#define Clock_100kHz__CFG2 CYREG_CLKDIST_DCFG1_CFG2
#define Clock_100kHz__CFG2_SRC_SEL_MASK 0x07u
#define Clock_100kHz__INDEX 0x01u
#define Clock_100kHz__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clock_100kHz__PM_ACT_MSK 0x02u
#define Clock_100kHz__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clock_100kHz__PM_STBY_MSK 0x02u

/* Clock_Trigger */
#define Clock_Trigger__CFG0 CYREG_CLKDIST_DCFG2_CFG0
#define Clock_Trigger__CFG1 CYREG_CLKDIST_DCFG2_CFG1
#define Clock_Trigger__CFG2 CYREG_CLKDIST_DCFG2_CFG2
#define Clock_Trigger__CFG2_SRC_SEL_MASK 0x07u
#define Clock_Trigger__INDEX 0x02u
#define Clock_Trigger__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clock_Trigger__PM_ACT_MSK 0x04u
#define Clock_Trigger__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clock_Trigger__PM_STBY_MSK 0x04u

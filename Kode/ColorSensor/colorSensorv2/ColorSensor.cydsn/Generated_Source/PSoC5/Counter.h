...
#define Counter_INIT_PERIOD_VALUE       10000u
...
#define Counter_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ...
        ((uint8)((uint8)1u << Counter_STATUS_OVERFLOW_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)1u << Counter_STATUS_UNDERFLOW_INT_EN_MASK_SHIFT)))
